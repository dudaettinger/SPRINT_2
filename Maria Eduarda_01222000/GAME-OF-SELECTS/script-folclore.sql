...
drop table lenda,cantiga,brincadeira,comidas,regiao,literatura,danca,festa,localizacao,cultura,jogos,comidasDeFestas,culturaLiteraria;
...
ALTER TABLE culturaLiteraria ADD COLUMN DatadeCriacao CHAR(4);
...
(null,'sul','Paraná (PR)'),
(null,'sul','Santa Catarina (SC)'),
(null,'sul',' Rio Grande do Sul (RS)'),
(null,'sudeste',' "Espírito Santo (ES)'),
(null,'sudeste','Minas Gerais (MG)'),
(null,'sudeste','Rio de Janeiro(RJ)'),
(null,'sudeste','São Paulo(SP)'),
(null,'nordeste','Maranhão(MA)'),
(null,'nordeste','Piauí(PI)'),
(null,'nordeste','Ceará(CE)'),
(null,'nordeste','Rio Grande do Norte(RN)'),
(null,'nordeste','Paraíba(PB)'),
(null,'nordeste','Pernambuco(PE)'),
(null,'nordeste','Alagoas(AL)'),
(null,'nordeste','Sergipe(SE)'),
(null,'nordeste','Bahia(BA)'),
(null,'norte','Amazonas (AM)'),
(null,'norte','Pará (PA)'),
(null,'norte','Acre (AC)'),
(null,'norte','Roraima (RR)'),
(null,'norte','Rondônia (RO)'),
(null,'norte','Amapá (AP)'),
(null,'norte','Tocantins (TO)'),
(null,'centro oeste','Goiás (GO)'),
(null,'centro oeste','Mato Grosso (MT)'),
(null,'centro oeste','Mato Grosso do Sul (MS) '),
(null,'centro oeste','Distrito Federal (DF)');
...
('1 a 30', 'junho', '1', '2'),
('30', 'junho', '2', '3'),
('1 a 29', 'fevereiro', '3', '1'),
('6', 'janeiro', '4', '5'),
('8 a 10', 'outubro', '5', 6),
('7 a 17', 'julho', '6', 7),
('9', 'outubro', '7', 9),
('17 a 3', 'setembro/outubro', '8', 10),
('18 a 28', 'agosto', '9', '14'),
('5 a 7', 'junho', '10', '23'),
('13', 'janeiro', '11', '11'),
('14', 'abril', 12, '11'),
